# genpark-agent-budget-metering-prepaid-credit-wallet-skill
...
> **GenPark AI Agent Skill** -- Agent budget metering prepaid credit wallet & velocity caps (Skyfire style)
